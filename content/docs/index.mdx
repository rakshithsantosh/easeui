---
title: Installation
description: Getting started with easeui
icon: ListStart
---
...
```bash tab="pnpm"
pnpm dlx shadcn@latest add https://easeui/r/utils.json
```
...
```jsx
import Card05 from "@/components/easeui/card-05";
 ...
 */
import AICardGeneration from "@/components/easeui/AICardGeneration";
